# $Id: plain_bst.rb,v 1.14 2004/05/05 18:37:48 tominaga Exp $
=begin
Copyright (C) 2004 Kazuto Tominaga.  All rights reserved.
...
class Formatter
  ...
  def sort
	...
	# $stderr.puts "debug: namesa '#{namesa}'"
	if bauthor
	...
	# $stderr.puts "debug: sort '#{namesa}' <=> '#{namesb}k"
	namesa <=> namesb
      end
    end
  end
